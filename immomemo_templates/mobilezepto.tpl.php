...
<head>
	...
	<script type="text/javascript">
        ...
        function display_choose_buildings(buildings){
        	...
        	var buildings_nav = '<div id="buildings_nav"><div id="buildings_line_1" style="-webkit-transform: translateX(0px);"></div><div id="buildings_line_2"><div id="buildings_nav_left">Left</div><div id="buildings_nav_name"></div><div id="buildings_nav_right">Right</div></div><div id="buildings_line_3"></div></div>';
            $('#contents').append(buildings_nav);
            $('#buildings_nav_name').text(street);
            ...
            scroll($("#data").offset().top+'px', 1000);

            $('#buildings_nav_name').on('click', function(){
                scroll('0px', 1000);
            });

            Hammer(document.getElementById('buildings_nav'))
            .on("dragstart", function(event) {
                nav_css = $('#buildings_line_1').css("-webkit-transform");
                nav_pos = parseInt(nav_css.substring(11, nav_css.length-3)) ;
            })
            ...
            .on("dragright", function(event) {
                ...
                pos = nav_pos - event.gesture.deltaX ;
                $('#buildings_line_1, #buildings_line_3 ').animate({
                    translateX: (nav_pos+event.gesture.deltaX)+'px'
                }, 0);
            })
...
<body>
    ...
    <script type="text/javascript" src="<?= $base_url ?>/sites/all/libraries/zepto.js"></script>
    <script type="text/javascript" src="<?= $base_url ?>/sites/all/libraries/zepto.fx.js"></script>
